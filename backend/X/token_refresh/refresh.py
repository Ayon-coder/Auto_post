...
def _x_buffer_token():
    return (os.getenv("X_BUFFER_ACCESS_TOKEN") or "").strip()
...
class TokenManager:
    ...
    def get_valid_token(self):
        ...
        if not self.access_token:
            raise ValueError(
                "X Buffer token missing. Set X_BUFFER_ACCESS_TOKEN in your .env "
                "(separate from LinkedIn - Buffer API key tied to your X/Twitter channel)."
            )
        ...
        raise ValueError(
            ...
            "https://buffer.com/developers/api and update X_BUFFER_ACCESS_TOKEN in your .env."
        )
